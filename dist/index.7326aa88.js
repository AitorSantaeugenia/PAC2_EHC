...
const e=document.getElementById("trailerVideo"),t=document.getElementById("imageTrailerFigcaption"),d=document.getElementById("overlayDiv"),n=document.getElementById("imagePoster");// FUNCTION TO HIDE THE MINDHUNTER POSTER AND SHOW THE TRAILER
...
n.classList.remove("hidden"),t.innerHTML=`P\xf3ster oficial de Mindhunter, temporada 2. | Imagen de <a href="https://www.rottentomatoes.com/tv/mindhunter/s02" target="_blank">Rotten Tomatoes</a>`,e.classList.add("hidden")},!1);//# sourceMappingURL=index.7326aa88.js.map

//# sourceMappingURL=index.7326aa88.js.map
